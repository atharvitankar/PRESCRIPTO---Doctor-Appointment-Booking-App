...
//   const handleSendMail = async (to, subject, message) => {
//   try {
//     await axios.post('/api/send-email', { to, subject, message });
//   } catch (error) {
//     console.error('Email error:', error);
//   }
// };
...
//                   ? <p className='text-green-500 text-xs font-medium'>Completed</p>
//                   : <div className='flex'>
//                     <img onClick={() => {cancelAppointment(item._id);sendMail("atharv.itankar02@gmail.com","Appointment status","Your appointment is cancelled.");}} className='w-10 cursor-pointer' src={assets.cancel_icon} alt="" />
//                     <img onClick={() => {completeAppointment(item._id);sendMail("atharv.itankar02@gmail.com","Appointment status","Your appointment is confirmed.");}} className='w-10 cursor-pointer' src={assets.tick_icon} alt="" />
//                   </div>
//               }
//             </div>
//           ))}
